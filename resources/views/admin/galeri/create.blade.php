...
<body>
    ...
    <main class="main">
        ...
        <div class="topbar">
            <div class="topbar-title">Tambah Galeri</div>
        ...
        <div class="page-head">
            <h1>Tambah Galeri</h1>
            <p>Tambahkan kegiatan baru beserta foto-fotonya ke galeri website sekolah.</p>
        </div>
            ...
            <form action="{{ route('admin.galeri.store') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <textarea
                        ...
                        id="deskripsi"
                        class="form-control"
                        placeholder="Ceritakan singkat kegiatan ini (opsional)"
                ...
                <div class="form-group">
                    ...
                    <label class="file-drop" for="foto">
                        ...
                        <span>Klik untuk pilih foto (boleh lebih dari satu)</span>
                    </label>
                    ...
                    <div class="hint">Format JPG, JPEG, PNG, atau WEBP. Maksimal 5 MB per foto.</div>
                ...
                <div class="form-actions">
                    <button type="submit" class="btn-submit">
                        <i class="bi bi-check-circle"></i> Simpan Galeri
                    </button>
